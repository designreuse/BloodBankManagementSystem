    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Edit Blood Bag Information</h5>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group <c:if test="${!empty bloodBagIdHasBindError}" > has-error </c:if> ">
                                ...
                                <sf:input path="bloodBagId" cssClass="form-control" readonly="readonly" palceholder="Blood Bag Number" />
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="" style="margin-top: 39px"> 
                                    <button class="btn btn-sm btn-info" type="submit">Update Information</button>
                                </div>
                            </div>
                        </div>
                    </div>
